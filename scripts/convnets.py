...
class BearCartNet(nn.Module):
    ...
    def forward(self, x):  # 224
        x = self.relu(self.conv1(x))  # (224 - 7 + 2 * 3) / 2 + 1 = 112
        x = self.relu(self.conv2(x))  # (112 - 5 + 2 * 1) / 2 + 1 = 55
        x = self.relu(self.conv3(x))  # (55 - 3 + 2 * 1) / 2 + 1 = 28
        x = self.relu(self.conv4(x))  # (28 - 3 + 2 * 1) / 2 + 1 = 14
        x = self.relu(self.conv5(x))  # (14 - 3 + 2 * 1) / 2 + 1 = 7
        x = self.relu(self.conv6(x))  # 7 - 3 + 2 * 1 + 1 = 7
